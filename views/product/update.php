		...
		<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-lg-offset-2">
			...
			<form method="post" enctype="multipart/form-data" action="index.php?controller=product&action=postUpdate" >
				<div class="form-group">
					...
					<input type="text" class="form-control" id="IdProduct" name="IdProduct" value="<?php echo $product->id ?>">
				</div>
				<div class="form-group">
					<label for="NameProduct">Tên sản phẩm:</label>
					<input type="text" class="form-control" id="NameProduct" name="NameProduct" value="<?php echo $product->name ?>">
				</div>
				<div class="form-group">
					<label for="OldPrice">Giá cũ:</label>
					<input type="number" class="form-control" id="OldPrice" name="OldPrice" min="0" value="<?php echo $product->oldprice ?>">
				</div>
				<div class="form-group">
					<label for="NewPrice">Giá mới:</label>
					<input type="number" class="form-control" id="NewPrice" name="NewPrice" min="0" value="<?php echo $product->newprice ?>">
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<input type="number" class="form-control" id="Amount" name="Amount" min="1" value="<?php echo $product->amount ?>">
				</div>
