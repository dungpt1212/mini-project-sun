		...
		<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-lg-offset-2">
			...
			<form method="post" enctype="multipart/form-data" action="index.php?controller=product&action=postAdd" >
				...
				<div class="form-group">
					...
					<input type="number" class="form-control" id="OldPrice" name="OldPrice" min="0" placeholder="Giá cũ">
				</div>
				<div class="form-group">
					<label for="NewPrice">Giá mới:</label>
					<input type="number" class="form-control" id="NewPrice" name="NewPrice" min="0" placeholder="Giá mới">
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<input type="number" class="form-control" id="Amount" name="Amount" min="1" placeholder="Số lượng">
				</div>
